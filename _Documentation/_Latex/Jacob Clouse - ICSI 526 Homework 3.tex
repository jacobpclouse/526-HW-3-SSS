...
\end{enumerate}
\vspace{.1in}
\noindent We take the image and open it up in our first, then adjust all values so that the max is 250. Once we get our pixel values, we then generate our coefficients and create our shares. 
\vspace{0.2in}
