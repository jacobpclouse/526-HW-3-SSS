...
$\rightarrow$
$f(x) = 13.5*\left(\frac{x - 38}{37 - 38}\right) + 13*\left(\frac{x - 37}{38 - 37}\right)$\\

\noindent Solving for f(0):\\ \vspace{0.1in}

$f(0) = 13.5*\left(\frac{0 - 38}{37 - 38}\right) + 13*\left(\frac{0 - 37}{38 - 37}\right)$
$\rightarrow$
$f(0) = 13.5*\left(\frac{-38}{-1}\right) + 13*\left(\frac{-37}{1}\right)$
$\rightarrow$
$f(0) = 13.5*38 + 13*(-37)$\\
\vspace{0.1in}
...
\vspace{0.1in}
\noindent f(0) = \textbf{32} for the averaged formula, we just need to work backwards and see if we can get the 
